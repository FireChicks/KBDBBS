...
<script type="text/javascript">
	...
	function addChat(chatName, chatContent, chatTime, chatInquiryID, chatInquiryType)  {
		...
		if(chatInquiryID != "" && chatInquiryType == 0) {
			...
			$('#chatList').append('<div class="row">' + 
					...
					'</h4>' +
					'<p>' +
					'<a href="goodsView.jsp?itemID=' + chatInquiryID  +'">' +
			...
			$('#chatList').append('<div class="row">' + 
					...
					'</h4>' +
					'<p>' +
					chatContent + '<a class="btn btn-primary" href="orderDetail.jsp?orderID='+ chatInquiryID +'">주문 확인</a>' +
					'</p>' +
					'</div>' +
					'</div>' +
					'</div>' +
	...
	function itemInquiryFunction(){
		alert('상품 문의를 선택하셨습니다 문의하실 상품을 선택해주세요.');
		location.href = 'inquiryGoods.jsp';
	};
		
	function orderInquiryFunction(){
		alert('주문 문의를 선택하셨습니다 문의하실 주문을 선택해주세요.');
						...
						<div class="portlet-footer">
							<div class="row" style="height:90px;">
								...
								<div class="form-group col-xs-2">
									...
									<button type="button" class="btn btn-default" onclick="itemInquiryFunction();">상품 문의</button>
									<button type="button" class="btn btn-default" onclick="orderInquiryFunction();">주문 문의</button>
									<div class="clearfix"></div>
							</div>
						</div>
					</div>
